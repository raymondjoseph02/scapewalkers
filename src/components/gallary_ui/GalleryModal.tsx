...
const GalleryModal: React.FC<GalleryModalProps> = ({ isOpen, closeModal, modalText, modalImage }) => {
  return (
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex items-center justify-center min-h-full p-4 text-center">
            ...
            >
              ...
              <DialogTitle as="h3" className="text-2xl font-bold text-left text-black font-special">
               {modalText}
         </DialogTitle>
             <button
                   onClick={closeModal}
              ...
              <div className="mt-4">
          <img src={modalImage} alt="Gallery Item" className="object-cover w-full h-auto aspect-video" />
        </div>
